...
/*
Реализует стратегию нахождения такого колличетсво минимумов до искомого вектора,
 сколько указано в getMinNeighbors(int count). У нас указано пять искомых соседей
 */
...
public class MinimumStrategy {
    ...
    public String toString() {
        return "Для числа : "
                + newJPG.getLable() +
                ", Распознанный класс = " + mostOftenIncomingClass(newJPG);
    }
}
